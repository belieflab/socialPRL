...
jsPsych.plugins["single-stim"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    trial.save_data = (typeof trial.save_data == 'undefined') ? true : trial.save_data;// trial.save_data || true; // if false, we don't save any data.
    ...
    var end_trial = function() {
      ...
      if (trial.save_data == false) {
        trial_data = null_data;
      }; 
