...
public class StimPath {		
	   ...
	   public void reliability() throws InterruptedException {
		   ...
		   String ActualStimPath = (String) "stimuli/deck_";
		   String ExpectedStimPath = (String) js.executeScript("return deckImagePrefix");
		   Assert.assertEquals(ExpectedStimPath, ActualStimPath);
